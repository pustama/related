var safelink = {
  converter: 'https://saflign.blogspot.co.id/2018/05/the-best-conference-call-services.html,https://saflign.blogspot.co.id/2018/05/virtual-data-room-providers.html,https://saflign.blogspot.co.id/2018/05/5-top-online-stock-brokers.html,https://saflign.blogspot.co.id/2018/05/best-car-insurance-rates-in-virginia.html', // Link Converter
  link: 'blogger.com,rpail.blogspot.com,rpail.blogspot.co.id,pustakamadrasah.blogspot.co.id,pustakamadrasah.blogspot.com,https://gudangdu.blogspot.com,pustakamadrasah.web.id', // Masukan link yang tidak ingin di convert otomatis.
  system: 2,
...
function redirectCU(e) {
  if (e.ctrlKey && e.which == 85) {
    window.location.replace("https://gudangdu.blogspot.com/");
    return false;
  }
}
